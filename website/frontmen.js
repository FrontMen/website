...
----------
Version: 0.0.26
Timestamp: Thu Nov 20 2014 20:19:11 
----------*//*!
 * Modernizr v2.8.3
 * www.modernizr.com
 *
...
(function () {
    ...
    //    $('<div/>', {
    //        'id' : 'slideNav'
    //    }).append($('<ul><li class="slideNavPrev"><a class="disabled" href="#" title="Go to previous slide"><span class="ico ico-up">â†‘</span></a></li><li><span id="activeSlide">'+activeSlide+'</span>/<span id="maxSlides">'+slidesCount+'</span></li><li class="slideNavNext"><a href="#" title="Go to next slide"><span class="ico ico-down">â†“</span></a></li></ul>')).appendTo('body').delay(1200).fadeIn(duration);
    //
