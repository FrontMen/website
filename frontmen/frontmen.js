...
----------
Version: 0.0.6
Timestamp: Fri Oct 03 2014 17:15:18 
----------*//*!
 * VERSION: 1.11.8
 * DATE: 2014-05-13
...
$(document).ready(function() {
    ...
    new ScrollScene({triggerElement: "#technology"})
        .setClassToggle(".section2", "active") // add class toggle
        .addTo(controller);

    new ScrollScene({triggerElement: "#projects"})
        .setClassToggle(".section3", "active") // add class toggle
        .addTo(controller);

    new ScrollScene({triggerElement: "#team"})
        .setClassToggle(".section5", "active") // add class toggle
        .addTo(controller);

    new ScrollScene({triggerElement: "#what-we-do"})
        .setClassToggle(".section6", "active") // add class toggle
        .addTo(controller);

    new ScrollScene({triggerElement: "#partners"})
        .setClassToggle(".section7", "active") // add class toggle
        .addTo(controller);

    new ScrollScene({triggerElement: "#contact"})
        .setClassToggle(".section8", "active") // add class toggle
        .addTo(controller);
